...
app.get('/Hello', (req, res) => {
  ...
  urls = 'http://3.36.103.168:8000/hello';
...
app.get('/api/users', (req, res) => {
  ...
  axios
    ...
    .get('http://3.36.103.168:8000/api/users')
...
app.get('/api/users/user', (req, res) => {
  ...
  if (req.query.name == null) {
    ...
    urls = 'http://3.36.103.168:8000/api/users/user?user_id=' + req.query.user_id;

  } else {

    urls = 'http://3.36.103.168:8000/api/users/user?user_id=' + req.query.user_id + '&name=' + req.query.name;
...
app.get('/api/users/:user_id', (req, res) => {
  ...
  urls = 'http://3.36.103.168/api/users/' + req.params.user_id;
...
app.post('/api/users/userBody', (req, res) => {
  ...
  const option = {
    ...
    uri: 'http://3.36.103.168/api/users/userBody',
...
app.post('/api/users/add', (req, res) => {
  ...
  const option = {
    ...
    uri: 'http://3.36.103.168/api/users/add',
...
app.put('/api/users/update', (req, res) => {
  ...
  const option = {
    ...
    uri: 'http://3.36.103.168/api/users/update',
...
app.patch('/api/users/update/:user_id', (req, res) => {
  ...
  const option = {
    ...
    uri: 'http://3.36.103.168/api/users/update/' + req.params.user_id,
...
app.delete('/api/users/delete', (req, res) => {
  ...
  const option = {
    ...
    uri: 'http://3.36.103.168/api/users/delete',
