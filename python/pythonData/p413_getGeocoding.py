...
address = '서울 마포구 신수동 451번지 세양청마루 아파트 상가 101호'
...
folium.Marker(location=[latitude, longitude], icon=myicon,
              popup=shopinfo).add_to(foli_map)
folium.CircleMarker([latitude, longitude], radius=300, color='blue', fill_color='red',
                    fill=False, popup=shopinfo).add_to(foli_map)
foli_map.save('./xx_shop_map.html')
print('file saved...')