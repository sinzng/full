...
alias_mask =  np.array(img_file)
print(type(alias_mask))
print('-'*50)

plt.figure(figsize = (8,8))
plt.imshow(alias_mask, interpolation='bilinear')
plt.axis('off')
...
wc = WordCloud(background_color ='white', stopwords=mystopwords, max_words=2000, mask=alias_mask)
stevefile = 'steve.txt'
...
wc = WordCloud(background_color ='white', stopwords=mystopwords, mask=alice_color_mask, max_words=2000,
